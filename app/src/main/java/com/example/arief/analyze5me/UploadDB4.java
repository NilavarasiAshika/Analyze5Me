 ...
 */
public class UploadDB4 extends SQLiteOpenHelper {
    public UploadDB4(Context context) {
        super(context,"do",null,1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table pbtable(r text, aop text,bop text,cop text,dop text,ans text,qon integer,sta integer,code text,topic text)");

    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("drop table if exists pbtable");
    }
    public void insertquestion(String q,String a,String b,String c,String d,String cur,int qn,int sta,String code,String top)
    {
        ...
        obj.execSQL("insert into pbtable values('" + q + "','" + a + "','" + b + "','" + c + "','" + d + "','" + cur + "'," + qn + "," + sta + ",'" + code + "','" + top + "')");
    }

    public boolean check(String pa)
    {
        SQLiteDatabase obj2=getWritableDatabase();
        Cursor cr= obj2.rawQuery("select ans from pbtable where  ans='"+pa+"'",null);
        if(cr.moveToNext())
        {
            return true;
        }
    ...
    public Cursor que(int n,int staff,String co,String top)
    {
        SQLiteDatabase bo=getWritableDatabase();
        Cursor c=bo.rawQuery("select * from pbtable where qon="+n+" and sta="+staff+"",null);
        return c;
    }
    ...
    public List<Integer> getAllLabels1(){
        ...
        // Select All Query
        String selectQuery1 = "SELECT distinct sta FROM pbtable";
    ...
    public List<String> getAllLabels2(){
        ...
        // Select All Query
        String selectQuery2 = "SELECT distinct code FROM pbtable";
    ...
    public List<String> getAllLabels3(){
        ...
        // Select All Query
        String selectQuery3 = "SELECT distinct topic FROM pbtable";
